package com.example.peluqueriaps
...
class PeluqueriaPS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_peluqueriaps)
        ...
        toggleCalendarButton.setOnClickListener {
            ...
            // Acción adicional al alternar el estado del calendario
        }
    }
