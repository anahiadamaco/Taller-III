        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-2xl font-medium mb-1" htmlFor="ModoContacto">
                            Modo de Contacto
                        </label>
                        <select
                            id="ModoContacto"
                            name="ModoContacto"
                            value={Form.ModoContacto}
                            onChange={handleChange}
                            className="w-full p-2 border-2 border-blue-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200"
                        >
                    ...
                    <div>
                        <label className="block text-2xl font-medium mb-1" htmlFor="Direccion">
                            Dirección
                        </label>
                        <input
                            type="text"
