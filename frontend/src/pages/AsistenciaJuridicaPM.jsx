...
const AsistenciaJuridica = () => {
  ...
  // Función para filtrar especialistas según la búsqueda
  const filteredPersonas = personas.filter((persona) => {
    return (
      persona.nombre.toLowerCase().includes(searchQuery.toLowerCase()) ||
      persona.especialidad.toLowerCase().includes(searchQuery.toLowerCase())
    );
  });
  ...
  return (
    <div className="min-h-screen bg-gray-200 overflow-hidden flex flex-col">
      ...
      <div className="bg-red-600 text-white text-center py-16">
        <h1 className="text-4xl font-bold mb-4">Bienvenido a Asistencia Jurídica</h1>
      ...
      <div className="flex-grow p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-xl border-2 border-red-600">
          <h1 className="text-2xl font-bold mb-4 text-red-700">Asistencia Juridica</h1>
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-xl border-2 border-red-600">
          <h2 className="text-xl font-bold text-red-700 mb-2">Servicios Juridicos Disponibles</h2>
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-lg w-full">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-red-700">{selectedEspecialista.nombre} - Horarios</h2>
              <button
      ...
      {isCalendarOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-full w-full md:max-w-4xl h-3/4 flex flex-col">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-red-700">Calendario de Asistencia Juridica</h2>
              <button
                onClick={toggleCalendar}
                className="text-red-600 hover:text-red-700 font-bold"
              >
            ...
            <div className="flex-grow overflow-auto">
              <iframe
                ...
                frameBorder="0"
                scrolling="no"
                title="Calendario de Asistencia Juridica"
              ></iframe>
            </div>
          </div>
        </div>
