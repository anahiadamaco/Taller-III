  ...
  return (
    <div className="min-h-screen bg-gray-200">
      ...
      <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-xl border-2 border-red-500">
          <h1 className="text-2xl font-bold mb-4 text-red-700">Asistencia Jurídica</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-xl border-2 border-red-500">
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-xl border-2 border-red-500">
          <h2 className="text-xl font-bold text-red-700 mb-2">Servicios Legales Disponibles</h2>
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-4xl w-full">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-red-700">Calendario de Asistencia Jurídica</h2>
              <button 
                onClick={toggleCalendar} 
