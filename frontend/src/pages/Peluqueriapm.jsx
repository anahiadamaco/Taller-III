      ...
      <main className="flex-1 flex justify-center relative" style={{ backgroundImage: `url(${Fondo})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className='bg-white h-full w-full max-w-5xl mx-auto p-10 rounded-lg shadow-lg z-10 flex items-center relative'>
          <div className='w-full p-10'>
            <h1 className='text-center text-2xl font-bold mb-6'>Servicio de Peluquería</h1>
            
            {/* Descripción centrada */}
            <p className="text-center mb-6 text-lg text-gray-700">Nuestro servicio de peluquería ofrece cortes de cabello, peinados y coloración para todos los gustos.</p>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                  ...
                  <ul className="list-disc pl-5 text-gray-700">
                    <li>Juan Pérez - Especialista en Cortes de Cabello</li>
                    <li>Ana Gómez - Experta en Peinados</li>
                    <li>Pedro Ruiz - Técnico en Coloración</li>
                  </ul>
                </div>
