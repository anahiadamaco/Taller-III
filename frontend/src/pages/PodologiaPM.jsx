      ...
      <main className="flex-1 flex justify-center relative" style={{ backgroundImage: `url(${Fondo})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className='bg-white h-full w-full max-w-5xl mx-auto p-10 rounded-lg shadow-lg z-10 flex items-center relative'>
          <div className='w-full p-10'>
            <h1 className='text-center text-2xl font-bold mb-6'>Servicio de Podologia</h1>
            
            {/* Descripción centrada */}
            <p className="text-center mb-6 text-lg text-gray-700">Nuestro servicio de podologia ofrece tratamiento para uñas, cuidados de pie diabético , entre otras.</p>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                  ...
                  <ul className="list-disc pl-5 text-gray-700">
                    <li>María López - Especialista en Podología</li>
                    <li>Carlos Díaz - Podólogo Clínico</li>
                    <li>Ana Sánchez - Experta en Tratamientos Podiátricos</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                  ...
                  <ul className="list-disc pl-5 text-gray-700">
                    <li>Consulta Podológica</li>
                    <li>Tratamiento de Uñas Encarnadas</li>
                    <li>Cuidados de Pies Diabéticos</li>
                    <li>Revisión y Prevención de Lesiones</li>
                  </ul>
=======
