...
function Registro() {
  ...
  const [contrasena, setContrasena] = useState('');  // Cambio realizado aquí
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('http://localhost:3000/api/registerPM', {
        ...
        body: JSON.stringify({ rut, nombre, apellido_paterno, apellido_materno, fechaNacimiento, celular, correo: email, contrasena }),  // Cambio realizado aquí
      });
        ...
        <div className='container mx-auto w-full my-20 flex justify-center'>
          <div className="bg-white p-10 rounded-md shadow-xl flex flex-col items-center w-1/3">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col ">
              <p className="text-2xl text-black mt-4 fond-bold">Ingrese su RUT</p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su nombre: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su apellido paterno: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su apellido materno: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su Fecha de Nacimiento: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su número de celular: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su correo electrónico: </p>
              ...
              <p className="text-2xl text-black mt-2">Ingrese su Contraseña: </p>
              <input type="password" value={contrasena} onChange={(e) => setContrasena(e.target.value)} required className="bg-white border border-black text-black px-4 py-2 rounded-md my-4 w-72" autoComplete="off"></input>

              <button type="submit" className="text-2xl border border-black rounded-md w-20 h-9 bg-white hover:bg-red-300">
                Ingresar
              </button>
              <p>{mensaje}</p>
            </form>
