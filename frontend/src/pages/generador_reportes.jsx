        ...
        <div className='bg-slate-900 h-full w-full max-w-screen-2xl mx-auto p-10 shadow-lg z-10 flex items-center relative'>
          ...
          <div className='w-full p-10'>
            ...
            <div className="py-8 grid grid-cols-2 grid-rows-1 gap-8">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-center my-4 text-white">Personas Mayores (PM)</h2>
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4 text-center my-4 text-white">Prestadores de servicio(PS)</h2>
                <div className="flex justify-center mb-2">
